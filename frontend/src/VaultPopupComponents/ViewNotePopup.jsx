...
export default function ViewNotePopup({setShowPopup, data}) {
    ...
    if(!note){
        return(
            <div className='popup-container' style={{height: '98%', width: '98%', top: '1%', left: '1%', overflowY: 'scroll', scrollbarWidth: 'none', padding: 0}}>
    ...
    return (
        <div className='popup-container' style={{height: '98%', width: '98%', top: '1%', left: '1%', overflowY: 'scroll', scrollbarWidth: 'none', borderTop: `8px solid ${data.categoryColor}`}}>
